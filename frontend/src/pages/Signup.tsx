    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-6">
      <div className="w-full max-w-sm space-y-4">
        <div className="text-center">
          ...
          <h1 className="font-heading text-2xl font-bold text-foreground mt-8">Create an account</h1>
          <p className="text-muted-foreground text-sm mt-2">Get started with ApexStudio</p>
        </div>
